<%-- 
    Document   : index
    Created on : 11-May-2023, 8:00:57 AM
    Author     : gauhar
--%>
...
<html>
    ...
    <body>
        ...
        <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <!-- Footer -->
            <footer
                class="text-center text-lg-start text-white expand-lg"
                ...
                <!-- Copyright -->let fieldValilet fieldValidator = function(a,b){
                        ...
                        <form action="http://localhost:8080/elearningproject/c/?action=model&page=UserloginModel" method="POST">
                            <div class="form-group">
                                <li>
                                    ...
                                    <input type="email" name="email" class="form-control" id="em" onblur="validator('em', 'sp');">
                                    <span id="sp"></span>
                                </li>
                            </div>
                            <div class="form-group">
                                <li>
                                    ...
                                    <input type="password" name="password" class="form-control" id="pw" onblur="validator('pw', 'sp2');">
                                    <span id="sp2"></span>
                                </li>
                            </div>
                    ...
                    <form action="http://localhost:8080/elearningproject/c/?action=model&page=LoginModel" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="cityscroll" name="city">
